...
import { addElectoralArea, cleanUp } from '../../actions/electoral';
...
const ElectoralArea = (props) => {
    ...
    useEffect(() => {
        ...
        if (success.status !== null && success.message) {
            ...
            setTimeout(() => {
                history && history.push('/electoral-areas/list-electoral-areas');
                setAlert({ state: false });
            }, 2000);
            return () => {
                props.cleanUp_();
                ...
                <form onSubmit={submit}>
                    ...
                    <div className={classes.margin_}>
                        ...
                        >
                            Add Electoral Area
                            {
                                       props.electoralAreas.isLoading ? 
                                       <CircularProgress
...
addElectoralArea.propTypes = {
    classes: PropTypes.object.isRequired,
};
const mapStateToProps = (state) => ({
    error: state.errors,
    success: state.success,
    electoralAreas: state.electoralAreas
});
export const cleanUp_ = () => cleanUp();

export default withStyles(styles)(
    connect(mapStateToProps, { addElectoralArea, cleanUp_ })(ElectoralArea)
);
